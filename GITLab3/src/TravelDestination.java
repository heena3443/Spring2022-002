...
public class TravelDestination {
	...
	public static void main(String[] args) {
				...
				System.out.println("My name is Noah Mesa. I wish to travel to Mexico one day !");
				System.out.println("My name is Rene Rodriguez. I wish to travel to Japan one dat !");
	}
