...
public class TravelDestination {
	...
	public static void main(String[] args) {
				...
				System.out.println("My name is Garrett Ashley. I wish to travel to Alaska one day !");
				System.out.println("My name is Rene Rodriguez. I wish to travel to Japan one day !");
				System.out.println("My name is Igor Derke. I wish to travel to Iceland one day!");
        ...
        System.out.println("My name is Rizwan khan.I wish to travel to France one day !");
				System.out.println("My name is Orlando Jones. I wish to travel to Alpha Centauri one day !");
        System.out.println("My name is Jonathan Aguirre. I wish to travel to Norway one day !");
        System.out.println("My name is Rizwan khan.I wish to travel to France one day !");
				System.out.println("My name is Ernesto Palacios. I wish to travel to Venice one day!");
				System.out.println("My name is Alejandro Bermea. I wish to travel to Japan one day!");
				System.out.println("My name is Krutin Patel. I wish to travel to Portugal one day!");
        System.out.println("My name is Mohamed Anees. I wish to travel to North Pole one day!");
		    System.out.println("My name is Opeyemi Ayeni. I wish to travel to Japan one day!");
				System.out.println("My name is Lissette De Leon, I wish to travel to Mars one day !");
				System.out.println("My name is Evan Ashley, I wish to travel to Spain one day !");
				System.out.println("My name is Ryan Harrison. I wish to travel to Germany one day!");
				System.out.println("My name is Eddie Morales. I wish to travel to Canada one day !");
				System.out.println("My name is Nicholas Garcia. I wish to travel to Spain one day!");
				System.out.println("My name is Mark Shenouda. I wish to travel to Greece one day!");
		                System.out.println("My name is Diem Bui. I wish to travel to Switzerland one day!");
	}
